...
pub use fs_store::{
    FileSystemSkillStore, InstalledSkill, RegistrySource, RegistrySyncReport, RegistrySyncStatus,
    SkillUninstallResult, open_default_skill_registry, open_default_skills_manager,
};
pub use model::{
