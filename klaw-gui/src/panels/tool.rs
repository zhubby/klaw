...
impl ToggleToolKind {
    ...
    fn enabled(self, config: &AppConfig) -> bool {
        match self {
            ...
            Self::AskQuestion => config.tools.ask_question.enabled,
            Self::Geo => config.tools.geo.enabled,
            Self::FileRead => config.tools.file_read.enabled,
    ...
    fn apply_enabled(self, config: &mut AppConfig, enabled: bool) {
        match self {
            ...
            Self::AskQuestion => config.tools.ask_question.enabled = enabled,
            Self::Geo => config.tools.geo.enabled = enabled,
            Self::FileRead => config.tools.file_read.enabled = enabled,
...
impl ToolPanel {
    ...
    fn tools(&self) -> Vec<ToolDescriptor> {
        let mut tools = vec![
            ...
            ToolDescriptor::new("ask_question", self.config.tools.ask_question.enabled),
            ToolDescriptor::new("geo", self.config.tools.geo.enabled),
            ToolDescriptor::new("file_read", self.config.tools.file_read.enabled),
